 ...
 * 2. Skapa en paketstrm beroende p�inparameter
 * 3. Skriv ev ut paketet om r�t debugniv
 * 4. Compressa ett paket
 * 5. Skriv ev ut comppaketet om r�t debugniv
 * 6. Decompressa paketet
 * 7. Skriv ev ut decomppaketet om r�t debugniv
...
int main(int argc, char *argv[])
{
	...
	seq_filename = "../packet/ip_packet";
	sequence_test_comp_and_decomp(seq_filename);
}
 ...
 * nr_Packages anger hur m�ga paket som skapas.
...
/*
 * J�fr paket "orgPackage" med paket "finalPackage"
 * om paketen � lika returneras true annars false
 */
...
/*
 * Skriver ut ett pakets inneh�l beroende p�vilken
 * debugniv�som programmet exekveras i.
 * debugLevel � den debugniv�som programmet krs i.
 * packageToPrint � det paket som ska skrivas ut.
 *
 */
...
/*
 * Anropas fr� dekompressorn och skriver ut ev debuginfo
...
void sequence_test_comp_and_decomp(char *filename)
{
	...
	// struct s_medium medium = {ROHC_SMALL_CID, 15, 3};
	struct sd_rohc *decomp = rohc_alloc_decompressor(NULL);
	struct sd_rohc *decomp2 = rohc_alloc_decompressor(NULL);
