...
int d_sdvalue_decode(const unsigned char *data)
{
	...
	else if (GET_BIT_6_7(data) == (0x8 >> 2))
	{ // bits == 10

		return (GET_BIT_0_5(data) << 8 | GET_BIT_0_7((data + 1)));
	}
	else if (GET_BIT_5_7(data) == (0xc >> 1))
	{ // bits == 110

		return (GET_BIT_0_4(data) << 16 | GET_BIT_0_7((data + 1)) << 8 | GET_BIT_0_7((data + 2)));
	}
	else if (GET_BIT_5_7(data) == (0xe >> 1))
	{ // bits == 111

		return (GET_BIT_0_4(data) << 24 | GET_BIT_0_7((data + 1)) << 16 | GET_BIT_0_7((data + 2)) << 8 | GET_BIT_0_7((data + 3)));
	}
	else
		return -1; // should not happen
}
